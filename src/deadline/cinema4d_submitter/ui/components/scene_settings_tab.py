...
class SceneSettingsWidget(QWidget):
    ...
    def _build_ui(self, settings):
        ...
        warning_label = QLabel(
            "⚠️ This option may use additional disk space temporarily and take longer to submit but this bundles the scene with its assets providing more chances of successful renders."
        )
